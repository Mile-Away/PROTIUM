...
Part 1: **Architecture** (Basic rules determining node connection methods)

Part 2: **Nodes** (Node structure and customization, Flociety data flow community)

Part 3: **Tasks** (Task queue)

Part 4: **CLI-Py** (Command line tool/Python package for direct submission)
