export const metadata = {
  ...
  这个小节介绍数据库中存储的 Workflow 模型，包括模型字段和请求方法。{{ className: 'text-neutral-200' }}
  
  ## The Workflow model
  
  Workflow 模型记录用户创建的工作流所有信息，你可以向数据库中添加、更新、删除和查询 Workflow。

  ### Properties

  <CodeGroup title="Model" tag="" label="/v1/contacts">
