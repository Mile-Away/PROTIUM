...
export default function NotFound() {
  return (
    <div className="relative h-screen isolate flex flex-auto flex-col items-center justify-center overflow-hidden bg-neutral-950 text-center">
      <svg
        aria-hidden="true"
      ...
      <IconLink href="/" className="mt-4 text-white">
        Go back home
      </IconLink>
    </div>
  );
