...
import SpaceHero from '@/app/(space)/space/[name]/SpaceHero';
import SpaceNavigation from '@/app/(space)/space/[name]/SpaceNavigation';
...
export default function Layout({ children, params }: LayoutProps) {
  ...
  return (
    <div className="relative mx-auto max-w-8xl px-4 2xl:max-w-screen-2xl">
