                        ...
                        >
                          <item.icon
                            className="h-6 w-6 flex-none
                             text-gray-400 group-hover:text-indigo-600 dark:text-gray-300 dark:group-hover:text-indigo-400  "
                            aria-hidden="true"
                          />
                          {item.name}
                        </Link>
                  ...
                  >
                    <div className="relative flex-none">
                      <img
                        ...
                        alt=""
                      />
                      <div className="absolute inset-0 rounded-lg ring-1 ring-inset ring-gray-900/10 dark:ring-gray-50/10" />
                    </div>
                    <div>
                      ...
                      <h4 className="mt-2 text-sm font-semibold leading-6 text-gray-900 dark:text-white">
                        <Link href={post.href}>
