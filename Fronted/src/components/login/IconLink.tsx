...
export function IconLink({
  ...
  return (
    <Link
      ...
      className={clsx(
        className,
        'group relative isolate flex items-center rounded-lg px-2 py-0.5 text-[0.8125rem]/6 font-medium dark:text-white/30 transition-colors hover:text-indigo-600 dark:hover:text-sky-300',
