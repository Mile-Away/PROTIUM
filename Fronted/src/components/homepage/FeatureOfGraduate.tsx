    ...
    return (
        ...
        <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
          ...
          >
            ...
            >
              DeepModeling is a community of such a group of
              people.
            </h1>
            <div className="mt-6 max-w-xl lg:mt-0 xl:col-end-1 xl:row-start-1">
              <p className="text-lg leading-8 text-gray-600 dark:text-gray-300">
                ...
                infrastructure, a new culture—the culture
                of working together closely for the benefit of all, of free
                exchange and sharing of knowledge and tools, of respect and
                appreciation of each other's work, and of the pursuit of harmony
                among diversity.
              </p>
            </div>
            <img
