'use client';
import { BiliBiliIcon, IoLogoWechat } from '@/components/SocialIcons';
...
const navigation = {
  ...
  social: [
    {
      name: 'Email',
      href: 'mailto:deepmodeling@deepmodeling.com',
      icon: (props: any) => <EnvelopeIcon className="h-6 w-6" {...props} />,
    },
    {
      name: 'GitHub',
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/DeepModeling',
      icon: (props: any) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    },
    {
      ...
      icon: (props: any) => <IoLogoWechat className="h-6 w-6" {...props} />,
    },

    {
      name: 'Zhihu',
      href: 'https://www.zhihu.com/org/shen-du-shi-neng-deep-potential',
      icon: (props: any) => <RiZhihuLine className="h-6 w-6" {...props} />,
    },
    {
      name: 'Bilibili',
      href: 'https://space.bilibili.com/626179751/',
      icon: (props: any) => <BiliBiliIcon className="h-6 w-6" {...props} />,
    },
  ],
};
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-8xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32 2xl:max-w-screen-2xl">
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 dark:border-gray-50/10 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          <div>
            <h3 className="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-50">
        ...
        <div className="mt-8 border-t border-gray-900/10 pt-8 dark:border-gray-50/10 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            {navigation.social.map((item) => (
              <Link
                ...
                target="_blank"
                href={item.href}
                className="fill-gray-400 text-gray-400 hover:fill-gray-500 hover:text-gray-500
                 dark:hover:fill-gray-300 dark:hover:text-gray-300"
              >
