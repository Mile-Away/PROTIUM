  ...
  return (
    ...
    >
      ...
      {isSticky ? (
        ...
        <div
          className=" absolute right-0 h-full w-2 cursor-e-resize bg-transparent hover:bg-gradient-to-r hover:from-indigo-600 hover:to-transparent dark:hover:from-indigo-400 dark:hover:to-transparent"
