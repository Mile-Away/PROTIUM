  ...
  return (
    <BasicNode {...props}>
      <div className="flex flex-col space-y-4 text-xs">
        ...
        {jobId && (
          <ul className="flex h-32 items-start justify-between rounded pt-8 ">
            <li
              className="group relative col-span-1 flex cursor-pointer rounded-md transition-all fade-in-5 duration-300 hover:shadow-md hover:shadow-black"
              onClick={() =>
