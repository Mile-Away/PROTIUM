import AISISponsorImage from '@/@brand/images/sponsor/AISI.png';
import DPTSponsorImage from '@/@brand/images/sponsor/DPT.png';
import MSEofSHUImage from '@/@brand/images/sponsor/MSEofSHU.png' 
import SHAOImage from '@/@brand/images/sponsor/SHAO.png'
  ...
  return (
    <div className="pb-2 dark:bg-neutral-950">
      <div className="mx-auto mt-8 max-w-7xl px-6 sm:mt-16 lg:px-8">
        <h2 className="text-center text-base font-semibold leading-8 text-gray-400">
          {t('sponsor')}
        </h2>
